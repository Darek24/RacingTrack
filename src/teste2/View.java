...
public class View extends javax.swing.JFrame {
    ...
    public View() {
        ...
        collision = new boolean [back1.getWidth()][back1.getHeight()];
        
        for(int i = 0; i<back1.getWidth();i++)
        {
        	 for(int j = 0; j<back1.getHeight();j++)
             {
        		 Color mycolor = new Color(back1.getRGB(i, j));
